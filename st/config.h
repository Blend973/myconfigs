...
/* mouse selection scroll interval in ms */
static unsigned int mouseselscrollinterval = 25;
...
static Shortcut shortcuts[] = {
    ...
    {MODKEY, XK_h, kscrollup, {.i = 10}},
    {MODKEY, XK_l, kscrolldown, {.i = 10}},
    {MODKEY, XK_a, chgalpha, {.f = -1}},
    {MODKEY, XK_s, chgalpha, {.f = +1}},
    {MODKEY, XK_d, chgalpha, {.f = 0}},
    {MODKEY, XK_Up, ttysend, {.s = "\033[A"}},
    {MODKEY, XK_Down, ttysend, {.s = "\033[B"}},
    {ControlMask,
     XK_BackSpace,
     kbsend,
     {.s = "\x17"}}, /* Ctrl+W for backward word kill */
    {ControlMask,
     XK_Delete,
     kbsend,
