...
myTextEditor     = "geany"
myWebBrowser     = "helium-browser"

-- CLI Apps
myCLIFileManager = myTerminal ++ " -e yazi"
myCLITextEditor  = myTerminal ++ " -e nvim"
...
-- Dmenu Menus
myDmenuPath :: String
myDmenuPath = "~/.config/xmonad/scripts/"
myDmenu_NETWORK   = myDmenuPath ++ "dmenu_network"
myDmenu_ROOT      = myDmenuPath ++ "dmenu_asroot"
myDmenu_BLUETOOTH = myDmenuPath ++ "dmenu_bluetooth"
myDmenu_LAUNCHER  = myDmenuPath ++ "dmenu_launcher"
myDmenu_MUSIC     = myDmenuPath ++ "dmenu_music"
myDmenu_SPOTIFY   = myDmenuPath ++ "dmenu_spotify"
myDmenu_POWER     = myDmenuPath ++ "dmenu_powermenu"
myDmenu_RUNNER    = myDmenuPath ++ "dmenu_runner"
myDmenu_SHOTS     = myDmenuPath ++ "dmenu_screenshot"
myDmenu_WINDOW    = myDmenuPath ++ "dmenu_windows"
...
myClipboard    = "~/.config/xmonad/scripts/dmenu_cliphist"
...
myKeys conf@(XConfig {XMonad.modMask = super}) = M.fromList $
    ...
    -- Launch applications
    , ((super,             xK_f),  spawn myFileManager)
    , ((super,             xK_z),  spawn myTextEditor)
    , ((super,             xK_w),  spawn myWebBrowser)
    , ((super .|. shiftMask,             xK_w),  spawn "helium-browser --incognito")

    -- Launch CLI applications
    , ((super,        xK_e),  spawn myCLIFileManager)
    , ((super,        xK_v),  spawn myCLITextEditor)
    ...
    -- , ((super .|. controlMask,                           xK_w),  spawn myRofi_WINDOW)

    -- Launch dmenu menus
    , ((mod1Mask,                       xK_space),  spawn myDmenu_LAUNCHER)
    , ((mod1Mask,                       xK_F2),  spawn myDmenu_RUNNER)
    , ((super,                           xK_n),  spawn myDmenu_NETWORK)
    , ((super,                           xK_r),  spawn myDmenu_ROOT)
    , ((super,                           xK_b),  spawn myDmenu_BLUETOOTH)
    , ((super,                           xK_m),  spawn myDmenu_MUSIC)
    --, ((super,                           xK_m),  spawn myDmenu_SPOTIFY)
    , ((super,                           xK_x),  spawn myDmenu_POWER)
    , ((super,                           xK_s),  spawn myDmenu_SHOTS)
    , ((super .|. controlMask,                           xK_w),  spawn myDmenu_WINDOW)
    ...
    , ((super,                           xK_c),  spawn $ myClipboard ++ " sel")
    ...
    , ((super,                           xK_d),  withFocused hideWindow)
    , ((super .|. shiftMask,                           xK_d),  popOldestHiddenWindow)
    , ((super .|. controlMask,                           xK_d),  popNewestHiddenWindow)
    ...
    -- Toggle fullscreen
    , ((super .|. shiftMask,                           xK_f),  toggleFull)
    , ((super .|. shiftMask,                           xK_b),  spawn "polybar-msg cmd toggle")
    ...
    , ((super .|. shiftMask,                           xK_p),  spawn "polybar-msg cmd restart")
...
-- ## Layouts ## -------------------------------------------------------------------------
myLayout = avoidStruts(dwm ||| Mirror tiled ||| Full)
    where
        -- default tiling algorithm partitions the screen into two panes
        dwm = IfMax 2 (Mirror tiled) tiled
...
myManageHook = composeAll . concat $
    ...
    where
        myCFloats = ["alacritty-float", "kitty-float", "Music", "MPlayer",
